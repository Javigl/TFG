...
class RentalsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rentals')->insert(['city'=>'Gijón', 'pickUpDate'=>'2022-03-01','returnDate'=>'2022-03-10', 'price'=> 20.0, 'car_id'=>2, 'user_id'=>4]);
        ...
        DB::table('rentals')->insert(['city'=>'Barcelona', 'pickUpDate'=>'2022-03-15','returnDate'=>'2022-03-19', 'price'=> 60.0, 'car_id'=>5, 'user_id'=>7]);
        DB::table('rentals')->insert(['city'=>'Valencia', 'pickUpDate'=>'2022-02-08','returnDate'=>'2022-02-13', 'price'=> 45.0, 'car_id'=>6, 'user_id'=>8]);
    }
}
